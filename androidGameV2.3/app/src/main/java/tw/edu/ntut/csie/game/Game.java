...
import tw.edu.ntut.csie.game.state.StateEnd;
import tw.edu.ntut.csie.game.state.StateOver;
import tw.edu.ntut.csie.game.state.StateReady;
import tw.edu.ntut.csie.game.state.StateRunOne;
import tw.edu.ntut.csie.game.state.StateRunTwo;
import tw.edu.ntut.csie.game.state.StateRunThree;
...
public class Game extends Activity {
    ...
    public static final int RUNNINGONE_STATE = 2;
    public static final int RUNNINGTWO_STATE = 3;
    public static final int RUNNINGTHREE_STATE = 4;
    public static final int OVER_STATE = 5;
    public static final int END_STATE = 6;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!_view.isInEditMode()) {
            ...
            _engine.registerGameState(RUNNINGONE_STATE, new StateRunOne(_engine));
            _engine.registerGameState(RUNNINGTWO_STATE, new StateRunTwo(_engine));
            _engine.registerGameState(RUNNINGTHREE_STATE, new StateRunThree(_engine));
            _engine.registerGameState(OVER_STATE, new StateOver(_engine));
            _engine.registerGameState(END_STATE, new StateEnd(_engine));
    ...
    public boolean onKeyUp(int keyCode, KeyEvent msg) {
        if (keyCode == KeyEvent.KEYCODE_MENU || keyCode == KeyEvent.KEYCODE_VOLUME_UP || keyCode == KeyEvent.KEYCODE_VOLUME_DOWN) {
