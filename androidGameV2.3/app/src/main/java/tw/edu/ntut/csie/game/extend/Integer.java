...
public class Integer implements GameObject {
    ...
    private void initialize() {
        ...
        _digitImages[0] = new MovingBitmap(R.drawable.zero);
        _digitImages[1] = new MovingBitmap(R.drawable.one);
        _digitImages[2] = new MovingBitmap(R.drawable.two);
        _digitImages[3] = new MovingBitmap(R.drawable.three);
        _digitImages[4] = new MovingBitmap(R.drawable.four);
        _digitImages[5] = new MovingBitmap(R.drawable.five);
        _digitImages[6] = new MovingBitmap(R.drawable.six);
        _digitImages[7] = new MovingBitmap(R.drawable.seven);
        _digitImages[8] = new MovingBitmap(R.drawable.eight);
        _digitImages[9] = new MovingBitmap(R.drawable.nine);
        _digitImages[10] = new MovingBitmap(R.drawable.enter);
    }
}
