...
public abstract class AbstractGameState extends GameState {
    ...
    public boolean pointerMultiReleased(List<Pointer> pointers) {
        return notifyPointerMultiReleasedEvent(pointers);
    }
    ...
    protected boolean notifyPointerMultiReleasedEvent(List<Pointer> pointers) {
        for (PointerEventHandler handler : _pointerHandlers) {
            if (handler.pointerMultiReleased(pointers)) {
                return true;
            }
        }
        return false;
